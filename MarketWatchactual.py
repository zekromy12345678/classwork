...
email = 'daniel.yadgarov23@sitechhs.com'
password = 'Tbd100179'
game = 'si-tech2023'
"""
try:
...
api = MarketWatch(email, password, game, False)

api.buy("AAPL", 1, term = Term.INDEFINITE, priceType = PriceType.MARKET, price = None)
