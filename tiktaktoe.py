...
# define a player move
  def askuser1(space):
    ...
    if placement == 'u1' or placement == 'u2' or placement == 'u3' or placement == 'm1' or placement == 'm2' or placement == 'm3' or placement == 'l1' or placement == 'l2' or placement == 'l3':
      if filled[placement] == 0:
        ...
        print('You have entered a wrong space or it has been taken your turn has been skipped.')
    else: 
      print('You have entered a wrong space or it has been taken your turn has been skipped.')
  def askuser2(space):
